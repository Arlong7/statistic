...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'create') {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO trade_union (date, employee_id) VALUES (?, ?)";
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "UPDATE trade_union SET date = ?, employee_id = ? WHERE id = ?";
            $stmt = $conn->prepare($sql);
        ...
        $check_trade_union_sql = "SELECT id FROM trade_union WHERE id = ?";
        $stmt = $conn->prepare($check_trade_union_sql);
        ...
        if ($result->num_rows > 0) {
            // Proceed with delete
            $sql = "DELETE FROM trade_union WHERE id = ?";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param('i', $id);
...
<body class="bg-gray-100 flex">
    ...
    <div class="container mx-auto mt-8">
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-2xl font-bold">Trade Union Management</h1>
        ...
        <div id="createModal" class="modal">
            <div class="modal-content">
                ...
                <h2 class="text-xl font-bold">Add New Trade Union Entry</h2>
                <form id="createForm">
        ...
        <div id="updateModal" class="modal">
            <div class="modal-content">
                ...
                <h2 class="text-xl font-bold">Update Trade Union Entry</h2>
                <form id="updateForm">
